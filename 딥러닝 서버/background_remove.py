...
def get_arg():
	...
	parser.add_argument("-width","--width", type=int, default=512, help="when size != 1, image width for resize")
	parser.add_argument("-height","--height", type=int, default=512, help="when size != 1, image height for resize")
